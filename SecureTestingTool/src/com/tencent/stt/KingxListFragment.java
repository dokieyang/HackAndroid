...
public class KingxListFragment extends ListFragment {

    	
    	
    	private SecureAdapter mAdapter;
    	
    	public static KingxListFragment newInstance(){
    		
    		return new KingxListFragment();
    	}
        ...
        class SecureAdapter extends BaseAdapter{
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				holder.mTitleTV.setText("kingx title " + position);
				holder.mCommentTV.setText("kingx comment" + position);
